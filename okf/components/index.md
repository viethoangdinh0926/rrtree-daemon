...
* [API server](api-server.md) - Express REST, SSE, static UI
* [UI](ui.md) - Live tree list, detail pane, curl copy
* [curl generator](curl.md) - Minimal curl from RrNode
* [Body helpers](bodies.md) - Which bodies to capture and how to truncate
